...
public class QuizActivity extends AppCompatActivity {
    ...
    private RadioButton a_option , b_option, c_option, d_option, rb_selected;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("questions_structure");
        ...
        answerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(radioGroup.getCheckedRadioButtonId()!=-1) {
                    ...
                    Toast.makeText(getApplicationContext(), "Please make a choice!", Toast.LENGTH_SHORT).show();
                }
    ...
    private void controlAnswers() {
        ...
        if(answerCheck()){
            ...
            scoreNum = scoreNum + 1;
            scoreText.setText("Score: " + " " + String.valueOf(scoreNum));
            Toast.makeText(getApplicationContext(),"Congratulations on the right answer",Toast.LENGTH_SHORT).show();

        }else{

            Toast.makeText(getApplicationContext(),"ISSUE FALSE ANSWER",Toast.LENGTH_SHORT).show();
